...
@Component
public class PortfolioFeeDailyReader implements ItemReader<PortfoliofeeDailyPO> {

//    private static final int PAGE_SIZE = 1000;
    private static final int PAGE_SIZE = 10;

    @Autowired
    private PortfoliofeeDailyMapper portfoliofeeDailyMapper;

    private List<PortfoliofeeDailyPO> currentBatch;
    ...
    @Override
    @DS("master")
    public PortfoliofeeDailyPO read() {
    ...
    private void loadNextBatch() {
        ...
        currentBatch = portfoliofeeDailyMapper.selectByPage(offset,PAGE_SIZE);
        currentIndex.set(0);
