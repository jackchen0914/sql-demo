...
@Component
@Slf4j
public class ClntPriceCapReader implements ItemReader<ClntPriceCapPO> {

    //    private static final int PAGE_SIZE = 1000;
    private static final int PAGE_SIZE = 5;//dev

    @Autowired
    private ClntPriceCapMapper clntPriceCapMapper;

    private List<ClntPriceCapPO> currentBatch;
    ...
    private void loadNextBatch() {
        ...
        currentBatch = clntPriceCapMapper.selectByPage(offset,PAGE_SIZE);
        currentIndex.set(0);
